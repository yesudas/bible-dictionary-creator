...
public class Constants {
	...
	public static final String STR_TITLE_IN_ENGLISH = "titleInEnglish";
	public static final String STR_AUTHOR = "author";
	public static final String STR_PUBLISHED_DATE = "publishedDate";
	public static final String STR_DESCRIPTION = "description";
	public static final String STR_DESCRIPTION_IN_ENGLISH = "descriptionInEnglish";
}
